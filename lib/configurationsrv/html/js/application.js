...
import {
  ...
  InvalidCredentialsDialog, SetAuthenticationDialog
} from './wizzards.js'
...
export class Application {
  ...
  hook () {
    ...
    $('#btn_authentication').bind('click', () => {
      let sad = new SetAuthenticationDialog(this)
      sad.setProceed(async (useAuth) => {
        await this.makeApiRequest({method: 'switchAuthentication', setOn: useAuth})
      })
      sad.run()
    })
