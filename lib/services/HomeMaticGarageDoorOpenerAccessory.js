    ...
    this.registerAddressForEventProcessingAtAccessory(this.buildAddress('DOOR_STATE'), (newValue) => {
      ...
      switch (parseInt(newValue)) {
        case 0:
          ...
          setTimeout(() => {
            self.currentDoorState.updateValue(self.characteristic.CurrentDoorState.CLOSED, null)
          }, 100)
          break
        case 1:
        case 2:
        case 3:
          ...
          setTimeout(() => {
            self.currentDoorState.updateValue(self.characteristic.CurrentDoorState.OPEN, null)
          }, 100)
          isOpen = true
          break
