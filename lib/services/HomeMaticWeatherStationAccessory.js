...
class HomeMaticWeatherStationAccessory extends HomeMaticAccessory {
  publishServices (Service, Characteristic) {
    ...
    Characteristic.CurrentAirPressureCharacteristic = function () {
      var charUUID = uuid.generate('HomeMatic:customchar:CurrentAirPressureCharacteristic')
      Characteristic.call(this, 'AirPressure', charUUID)
      this.setProps({
    ...
    Characteristic.CurrentRainCountCharacteristic = function () {
      var charUUID = uuid.generate('HomeMatic:customchar:CurrentRainCountCharacteristic')
      Characteristic.call(this, 'Rain count', charUUID)
      this.setProps({
        format: Characteristic.Formats.FLOAT,
        unit: 'mm',
        minStep: 0.1,
    ...
    Service.WeatherStation = function (displayName, subtype) {
      var servUUID = uuid.generate('HomeMatic:customchar:WeatherStation')
