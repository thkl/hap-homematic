...
class HomeMaticThermometerAccessory extends HomeMaticAccessory {
  publishServices (Service, Characteristic) {
    ...
    if (this.ignoreTemp === false) {
      ...
      this.registerAddressForEventProcessingAtAccessory(this.buildAddress('TEMPERATURE'), (newValue) => {
    ...
    if (this.ignoreHum === false) {
      ...
      this.registerAddressForEventProcessingAtAccessory(this.buildAddress('HUMIDITY'), (newValue) => {
