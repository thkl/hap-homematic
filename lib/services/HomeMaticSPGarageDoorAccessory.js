...
class HomeMaticSPGarageDoorAccessory extends HomeMaticAccessory {
  publishServices (Service, Characteristic) {
    ...
    if (this.loadSettings()) {
      ...
      if (this.twoSensorMode) {
        this.registerAddressForEventProcessingAtAccessory(this.buildAddress(this.address_sensor_close), function (newValue) {
        ...
        this.registerAddressForEventProcessingAtAccessory(this.buildAddress(this.address_sensor_open), function (newValue) {
          clearTimeout(self.requeryTimer)
